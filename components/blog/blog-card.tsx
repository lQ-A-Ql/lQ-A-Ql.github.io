...
export function BlogCard({
  ...
  const content = (
    ...
    >
      <Card className="group relative h-full cursor-pointer overflow-hidden rounded-[1.9rem] border border-white/12 bg-[linear-gradient(180deg,rgba(255,255,255,0.12),rgba(255,255,255,0.04)_16%,rgba(23,15,36,0.44)_46%,rgba(12,9,20,0.62)_100%)] py-0 shadow-[0_18px_44px_rgba(0,0,0,0.24)] backdrop-blur-[16px] transition-all duration-500 hover:border-primary/24 hover:shadow-[0_0_40px_rgba(235,99,197,0.12),0_18px_52px_rgba(0,0,0,0.3)]">
        <div className="pointer-events-none absolute inset-[-1px] rounded-[1.95rem] bg-[linear-gradient(180deg,rgba(255,255,255,0.40),rgba(255,255,255,0.08)_14%,rgba(255,255,255,0)_34%)] opacity-85" />
        <div className="pointer-events-none absolute inset-0 rounded-[1.9rem] bg-[radial-gradient(circle_at_top_right,rgba(255,132,190,0.16),transparent_34%),radial-gradient(circle_at_bottom_left,rgba(122,88,255,0.14),transparent_28%),radial-gradient(circle_at_50%_100%,rgba(255,255,255,0.1),transparent_35%)] opacity-90 transition-opacity duration-500 group-hover:opacity-100" />
        <div className="pointer-events-none absolute inset-x-[12%] top-0 h-[42%] rounded-b-[50%] bg-[radial-gradient(ellipse_at_top,rgba(255,255,255,0.24),rgba(255,255,255,0.05)_46%,transparent_76%)] opacity-90" />
        <div className="pointer-events-none absolute inset-x-[16%] bottom-[-10%] h-[32%] rounded-t-[50%] bg-[radial-gradient(ellipse_at_center,rgba(255,255,255,0.06),transparent_72%)] opacity-70" />
        ...
        <div className="pointer-events-none absolute inset-x-0 top-0 h-16 bg-[linear-gradient(180deg,rgba(255,255,255,0.16),rgba(255,255,255,0.015)_62%,transparent)] opacity-95" />
        <div className="pointer-events-none absolute inset-0 rounded-[1.9rem] border border-white/10 shadow-[inset_0_1px_0_rgba(255,255,255,0.16),inset_0_-12px_32px_rgba(0,0,0,0.06)]" />
        <div className="pointer-events-none absolute inset-[1px] rounded-[1.85rem] bg-[linear-gradient(135deg,rgba(255,255,255,0.1),rgba(255,255,255,0.018)_42%,transparent_70%)] opacity-75" />
        ...
        {imageUrl && (
          <div className="relative aspect-video overflow-hidden">
            ...
            <div className="absolute top-4 left-4">
              <span className="rounded-full border border-primary/24 bg-background/42 px-3 py-1 text-[11px] font-medium tracking-[0.14em] text-primary backdrop-blur-md">
                {category}
              </span>
            </div>
        ...
        <div className="relative flex h-full flex-col p-6">
          ...
          <p className="mb-6 line-clamp-4 text-sm leading-7 text-white/68">{excerpt}</p>
