        ...
        >
          ...
          <div className="flex items-center justify-center gap-6 mb-4">
            ...
            >
              ...
              <div className="absolute inset-0 -m-4 rounded-full bg-gradient-to-r from-primary/30 via-accent/30 to-primary/30 animate-spin-slow opacity-40 blur-md" style={{ animationDirection: "reverse", animationDuration: "12s" }} />
              <div className="relative h-32 w-32 overflow-hidden rounded-full shadow-[0_0_60px_rgba(235,99,197,0.4),0_0_120px_rgba(235,99,197,0.15)] hover:shadow-[0_0_80px_rgba(235,99,197,0.6),0_0_160px_rgba(235,99,197,0.25)] transition-shadow duration-500">
            ...
            <motion.h1
              ...
              style={{ textShadow: "0 0 40px rgba(235,99,197,0.3), 0 0 80px rgba(235,99,197,0.1)" }}
            >
